...
class DesktopOTPVerificationScreen extends StatelessWidget {
  @override
...
class DesktopOTPVerificationScreenPage extends StatefulWidget {
  final String value;

  DesktopOTPVerificationScreenPage({Key? key, required this.value})
      : super(key: key);

  @override
  DesktopOTPVerificationScreenPageState createState() {
    return new DesktopOTPVerificationScreenPageState(value);
  }
}

class DesktopOTPVerificationScreenPageState extends State {
  ...
  DesktopOTPVerificationScreenPageState(this.value) {
