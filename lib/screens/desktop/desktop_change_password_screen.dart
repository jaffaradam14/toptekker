...
class DesktopChangePasswordScreenPage extends StatefulWidget {
  final String mobile;
  final String from;

  DesktopChangePasswordScreenPage(
      {Key? key, required this.from, required this.mobile})
      : super(key: key);

  @override
  DesktopChangePasswordScreenPageState createState() {
    return new DesktopChangePasswordScreenPageState(from, mobile);
  }
}

class DesktopChangePasswordScreenPageState
    extends State<DesktopChangePasswordScreenPage> {
  ...
  DesktopChangePasswordScreenPageState(this.from, this.mobile) {
