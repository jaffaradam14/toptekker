...
Future<void> main() async {
  ...
  runApp(DesktopRazorpayScreen());
}

class DesktopRazorpayScreen extends StatelessWidget {
  @override
...
class DesktopRazorpayScreenPage extends StatefulWidget {
  final double width;
  final String date;
  ...
  const DesktopRazorpayScreenPage(
      {Key? key,
        required this.width,
        required this.date,
  ...
  @override
  DesktopRazorpayScreenPageState createState() {
    return new DesktopRazorpayScreenPageState(
        this.width,
        this.date,
        this.timeslot,
        this.mem_slots,
...
class DesktopRazorpayScreenPageState extends State {
  ...
  DesktopRazorpayScreenPageState(
      this.width,
      this.date,
      this.timeslot,
      this.mem_slots,
