...
Future<void> main() async {
  ...
  runApp(DesktopAcademyDetailsScreen());
}

class DesktopAcademyDetailsScreen extends StatelessWidget {
  @override
...
class DesktopAcademyDetailsScreenPage extends StatefulWidget {
  final double width;

  const DesktopAcademyDetailsScreenPage({Key? key, required this.width})
      : super(key: key);

  @override
  DesktopAcademyDetailsScreenPageState createState() {
    return DesktopAcademyDetailsScreenPageState(width);
  }
}

class DesktopAcademyDetailsScreenPageState extends State {
  ...
  DesktopAcademyDetailsScreenPageState(this.width);
  ...
  void gotoTimeSlotPage() {
    var route = new MaterialPageRoute(
        builder: (BuildContext context) => new TimeSlotScreenSize());
