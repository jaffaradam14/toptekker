...
class DesktopOrderScreenPage extends StatefulWidget {
  final double width;
  ...
  @override
  DesktopOrderScreenPageState createState() {
    return DesktopOrderScreenPageState(
        this.width,
        this.payment_by,
        this.transaction_id,
        this.date,
...
class DesktopOrderScreenPageState extends State {
  final double width;
  final String payment_by;
  final String transaction_id;
  final String date;
