...
import 'package:toptekker/screens/mobile/mobile_academy_details_screen.dart';
import 'package:http/http.dart' as http;
import '../../AppColors.dart';

Future<void> main() async {
  await GetStorage.init();
  runApp(DesktopAcademyScreen());
}

class DesktopAcademyScreen extends StatelessWidget {
  @override
...
class DesktopAcademyScreenPage extends StatefulWidget {

  final double width;

  const DesktopAcademyScreenPage({Key? key, required this.width}) : super(key: key);

  @override
  DesktopAcademyScreenPageState createState() {
    return new DesktopAcademyScreenPageState(this.width);
  }
}

class DesktopAcademyScreenPageState extends State {
  ...
  DesktopAcademyScreenPageState(this.width);
        ...
        child: ListTile(
          ...
          onTap: () {
            BusinessModel academyModel = new BusinessModel(
              ...
              newsDetail.bus_type,
              newsDetail.bus_fee,
              newsDetail.bus_con_time,
              newsDetail.working_days,
              newsDetail.upi_id,
              newsDetail.isFavorite,
              newsDetail.distance_in_km,
              newsDetail.cancellation_policy,
              newsDetail.cancellation_hour,
              newsDetail.booking_charge,
            );
      ...
      responseData['data'].forEach((academyDetail) {
        if (academyDetail != null) {
          final AcademyData news = AcademyData(
            ...
            academyDetail['bus_type'],
            academyDetail['bus_fee'],
            academyDetail['bus_con_time'],
            academyDetail['working_days'],
            academyDetail['upi_id'],
            academyDetail['isFavorite'],
            academyDetail['distance_in_km'],
            academyDetail['cancellation_policy'],
            academyDetail['cancellation_hour'],
            academyDetail['booking_charge'],
          );
          setState(() {
