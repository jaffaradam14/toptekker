...
class PaymentDetailsPageState extends State {
  ...
  PaymentDetailsPageState(
      String username, String phone, String selectedDate, String payFor) {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          margin: const EdgeInsets.only(
                              left: 0, top: 6.0, right: 0),
                          child: Text(turf_advance_amount.toString() + " INR"))
                    ],
                  ),
                ),
                Container(
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                  ...
                                  child: Text(
                                    total_advance_to_pay_now.toString() + " INR",
                                    style: TextStyle(
                                      fontSize: 12,
                                      fontWeight: FontWeight.bold,
                                    ),
