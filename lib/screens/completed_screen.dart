...
class CompletedScreenPage extends StatefulWidget {
  @override
  CompletedScreenPageState createState() {
    return new CompletedScreenPageState();
  }
}

class CompletedScreenPageState extends State {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          new Flexible(
            child: Image.network(
              Apis.base_url + "/uploads/admin/category/" + newsDetail.cat_image,
              height: 35,
